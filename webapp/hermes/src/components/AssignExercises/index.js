...
class AssignExercisesPage extends Component {
    constructor(props) {
	super(props);
	...
	if(loading) {
		...
		onChange={this.handleDateChange}
		    ...
		    <input onClick={this.handleAssignExercisesButton} type="button" value="Assign"/>
		    </div>
	    )
	}
    }
...
export default withFirebase(AssignExercisesPage);
